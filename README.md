...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/itables-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15009&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/itables-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `itables` can be installed with:

```
conda install itables
```

It is possible to list all of the versions of `itables` available on your platform with:
